...
// biome-ignore lint/correctness/noUnusedVariables: globalThis.toast may be used in future backup notifications
...
const model = {
	...
	validateBackupCompatibility() {
		...
		if (backupVersion !== currentVersion && backupVersion !== "development") {
			warnings.push(
				`Backup created with Apollos AI ${backupVersion}, current version is ${currentVersion}`,
			);
		}
